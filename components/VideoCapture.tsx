    ...
    if (videoActive) {
      ...
      try {
        ...
        if (error.name === "NotAllowedError") {
          ...
          setErrorMessage(
            "No camera found. Please ensure your camera is properly connected.",
          );
        } else if (error.name === "NotReadableError") {
          setErrorMessage(
            "Camera is in use by another application. Please close other applications using your camera.",
          );
        } else {
          setErrorMessage(
            error.message ||
        ...
        {videoActive ? (
          <div className="w-full h-full">
            <Webcam
              ...
              className="w-full h-full rounded-lg border mt-4 object-cover"
              screenshotQuality={1}
              imageSmoothing={true}
            ...
            {errorMessage ? (
              ...
              <>
                ...
                <p className="text-xs mt-2">
                  Your camera is required for the loan application process
                </p>
              </>
            )}
          </div>
