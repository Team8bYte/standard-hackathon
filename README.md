...
The Document Verification system allows users to upload required documents for their loan application:

1. **Dual Upload Options**:

   -  Upload existing document files from your device
   -  Directly capture documents using your camera

2. **Camera Capture Feature**:

   -  Click the "Take Photo" button next to any document
   ...
   -  The system will automatically process the captured document

3. **Supported Documents**:

   -  Aadhaar Card
   -  PAN Card
   -  Other identity and financial documents

4. **Automatic Information Extraction**:
   -  The system will automatically extract information from your documents
   -  Extracted data is pre-filled in your application to save time
   -  All documents are securely processed and never stored on external servers
